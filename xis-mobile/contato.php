...
<img src="img/barra_quadro_topo_1.png" alt="Título Criação de Websites" width="585" height="58"/>
<div class="titulo-interno"><h1>Contato</h1></div><!-- titulo-web -->
...
<table width="360px" border="0">
  ...
  <tr>
    <td align="right"><div style=" font-size:10px; color: #5C7D9E; font-family: Verdana, Geneva, sans-serif; float:left;">*Todos campos obrigatórios.</div><input name="Submit" type="submit" value="Enviar" id="botao"/></div><!-- campo -->
    </td>
  </tr>
</table>
</form>
...
Rua Padre Augusto, 106 - sala 401<br />
Montes Claros - MG<br />
